...
var tokenProviders = __webpack_require__(47361);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 824).then(__webpack_require__.t.bind(__webpack_require__, 89443, 23));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 824).then(__webpack_require__.t.bind(__webpack_require__, 89443, 23));
